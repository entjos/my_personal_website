...
[CRAN](https://cran.r-project.org/web/packages/ExclusionTable/index.html){.btn .btn-outline-primary .btn role="button"} [GitHub](https://github.com/entjos/ExclusionTable/){.btn .btn-outline-primary .btn role="button"}
